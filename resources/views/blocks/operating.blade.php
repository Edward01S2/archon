<section id="{!! $section !!}" class="section section-3">
  ...
  <div class="relative overflow-hidden md:flex">
    ...
    <div class="operate-carousel bg-white mx-6 my-12 pb-8 md:w-1/2 md:pb-0 md:my-16 lg:max-w-512 lg:ml-20 lg:mr-auto lg:my-24 xl:max-w-screen-sm xl:ml-0 xl:pl-16 2xl:max-w-720 2xl:my-32 2xl:pl-24">
